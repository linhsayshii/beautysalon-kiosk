...
export const router = createBrowserRouter([
  { path: '/login', lazy: () => import('@/pages/login/LoginPage') },
  {
    ...
    children: [
      ...
      { path: 'customer-cards', lazy: () => import('@/pages/customer-cards/MobileCustomerCardsPage') },
      { path: 'products', lazy: () => import('@/pages/products/MobileProductsPage') },
      { path: 'pricebooks', lazy: () => import('@/pages/pricebooks/MobilePricebooksPage') },
      { path: 'purchase-orders', lazy: () => import('@/pages/purchase-orders/MobilePurchaseOrdersPage') },
      { path: 'purchase-orders/new', lazy: () => import('@/pages/purchase-orders/MobilePurchaseOrderCreatePage') },
      { path: 'staff', lazy: () => import('@/pages/staff/MobileStaffManagementPage') },
      { path: 'staff/schedule', lazy: () => import('@/pages/staff/MobileStaffScheduleAdminPage') },
      { path: 'staff/attendance', lazy: () => import('@/pages/staff/MobileStaffAttendanceAdminPage') },
      { path: 'staff/payroll', lazy: () => import('@/pages/staff/MobileStaffPayrollAdminPage') },
      { path: 'staff/commissions', lazy: () => import('@/pages/staff/MobileStaffCommissionsAdminPage') },
      { path: 'schedule', lazy: () => import('@/pages/staff/MobileStaffSchedulePage') },
      { path: 'salary', lazy: () => import('@/pages/staff/MobileStaffSalaryPage') },
      { path: 'my-schedule', lazy: () => import('@/features/mobile-my-schedule/MobileMyScheduleView') },
      { path: 'attendance', lazy: () => import('@/pages/attendance/AttendanceScanPage') },
      { path: 'attendance/qr', lazy: () => import('@/pages/attendance/MobileAttendanceQrAdminPage') },
      { path: 'more', lazy: () => import('@/pages/more/MobileMorePage') },
      { path: 'notifications', lazy: () => import('@/pages/notifications/MobileNotificationsPage') },
